...
const contentTypes = [
  {
    label: 'Document',
    helper: 'PDF, notes, handouts',
    icon: <DescriptionOutlinedIcon />,
  },
  {
    label: 'Video',
    helper: 'Recorded lecture or video URL',
    icon: <OndemandVideoOutlinedIcon />,
  },
  {
    label: 'External Link',
    helper: 'Website or YouTube resource',
    icon: <LinkOutlinedIcon />,
  },
  {
    label: 'Presentation',
    helper: 'Slides and presentations',
    icon: <SlideshowOutlinedIcon />,
  },
  {
    label: 'Audio',
    helper: 'Lecture or podcast audio',
    icon: <HeadphonesOutlinedIcon />,
  },
  {
    label: 'Assessment',
    helper: 'Create or attach assessment',
    icon: <QuizOutlinedIcon />,
  },
  {
    label: 'Interactive',
    helper: 'SCORM or interactive package',
    icon: <CodeOutlinedIcon />,
  },
  {
    label: 'Text',
    helper: 'Reading or instructions',
...
const CourseBuilder = () => {
  ...
  const selectContentType = (label: string) => {
    setContentMessage(
      `${label} content uploader will be connected in the next step.`
    );
  };
                  ...
                  <CardContent sx={{ p: { xs: 2.5, md: 3 } }}>
                    ...
                    >
                      <Box>
                        ...
                        >
                          Choose any content type. Individual resources
                          remain optional.
                        </Typography>
                      </Box>
